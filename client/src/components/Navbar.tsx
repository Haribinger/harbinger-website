    ...
    >
      ...
      {mobileOpen && (
        <div className="lg:hidden bg-[#0a0a0f]/98 backdrop-blur-md border-t border-white/[0.04] py-2">
          ...
          <a href="/docs" className="block px-6 py-2.5 text-sm text-[#00d4ff] hover:text-[#00d4ff]/80 transition-colors">
            Docs
          </a>
          <a href="https://github.com/Haribinger/Harbinger" target="_blank" rel="noopener noreferrer" className="block px-6 py-2.5 text-sm text-[#888] hover:text-white transition-colors">
            GitHub
          </a>
        </div>
      )}
